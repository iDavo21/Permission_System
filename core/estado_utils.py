...
from core.constants import DIAS_EXPIRACION_PRONTO, FECHA_FORMAT
...
def contar_expiracion_proxima(registros, dias=None):
    if dias is None:
...
def clasificar_notificaciones(registros):
    hoy = datetime.now().date()
    vence_hoy = []
    vence_manana = []
    vence_proximos = []
