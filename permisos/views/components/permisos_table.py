    ...
    def __init__(self, permisos=None, on_edit=None, on_delete_confirm=None, on_view_detail=None, dark_mode=True):
        ...
        self.tabla = ft.DataTable(
            columns=[
                ...
                ft.DataColumn(ft.Text("Inicio", weight=ft.FontWeight.BOLD, color=tc["table_header"], size=13), on_sort=lambda e: self._ordenar("desde")),
                ft.DataColumn(ft.Text("Vencimiento", weight=ft.FontWeight.BOLD, color=tc["table_header"], size=13), on_sort=lambda e: self._ordenar("hasta")),
