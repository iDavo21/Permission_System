...
class LoginView(ft.Container):
    def __init__(self, on_login_click):
        ...
        # Entradas de texto minimalistas (solo con borde inferior)
        ...
        # Botón estilizado y estirado a todo el ancho
        self.login_button = ft.ElevatedButton(
            "Iniciar Sesión",
            width=320,
            style=ft.ButtonStyle(
                color=ft.Colors.WHITE,
                bgcolor=ft.Colors.GREEN_800,  # A juego con el verde del administrador
        ...
        # Diseño tipo "Card" flotante para albergar el formulario
        card = ft.Card(
            elevation=5,
            ...
            content=ft.Container(
                ...
                content=ft.Column(
                    ...
                    tight=True # Se ajusta a su contenido en forma minimalista
                )
            )
        )

        # Contenedor animado que envuelve la tarjeta
